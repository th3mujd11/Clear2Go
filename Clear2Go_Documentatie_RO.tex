...
\title{
    ...
    \large \textbf{\textcolor{blue!70!black}{Prezentată la InfoEducatie}}\\[0.3em]
    \normalsize Faza Nationala a olimpiadei InfoEducatie — 2024
}
\author{
...
Proiectul a parcurs etapa judeteana și a ajuns la {națională}, unde a fost prezentat în fața unui juriu de specialiști. Acest parcurs
...
utilizator validată de piloți reali.
...
\[
\text{MVP} \rightarrow \text{Aerodrom unic} \rightarrow
\text{Multi-aerodrom} \rightarrow \text{Release nationala}
\]
...
\begin{center}
\textbf{Clear2Go — dezvoltat de elevi, testat in aer.}\\[0.3em]
...
\textit{Data: Mai 2026}\\
\textit{Clasificare: Documentație Tehnică}\\
